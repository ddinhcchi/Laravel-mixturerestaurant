            ...
            <div class="w-3/5 bg-white shadow-lg">
                        ...
                        <table class="">
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr class="text-white bg-gray-800">
                                    ...
                                    <td class="text-sm font-bold"><b>{{  number_format($total, 0, '.', ' ')}} vnđ</b></td>
                                </tr>
                                <!--end tr-->
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-end justify-end space-x-3">
                        <a href="{{ route('admin.bill.invoice.pdf', [$table->id, $bill->id]) }}" class="px-4 py-2 text-sm text-yellow-600 bg-yellow-100">In bill</a>
                        <form
                            class="px-4 py-2 text-sm text-green-600 bg-green-100"
                            method="POST"
                            action="{{ route('admin.bill.invoice.paid', [$bill->id]) }}"
                            onsubmit="return confirm('Bạn chắc chắn thanh toán chứ?');">
                            @csrf
                            @method('PUT')
                            <button type="submit">Thanh toán</button>
                        </form>
                        <a href="{{ route('admin.menu.bill', $table->id) }}" class="px-4 py-2 text-sm text-red-600 bg-red-100">Hủy</a>
                    </div>
                </div>
