            ...
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-full mt-10">
                    <form method="POST" action="{{ route('admin.reservations.update', $reservation->id) }}">
                        ...
                        <div class="sm:col-span-6">
                            <label for="tel_number" class="block text-sm font-medium text-gray-700"> Số điện thoại
                            </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6">
                            <label for="guest_number" class="block text-sm font-medium text-gray-700"> Số khách
                            </label>
                            <div class="mt-1">
                        ...
                        <div class="mt-6 p-4">
                            <button type="submit"
                                class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Cập nhật</button>
                        </div>
                    </form>
                </div>
